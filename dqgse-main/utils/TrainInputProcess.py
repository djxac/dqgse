...
class TrainInputProcess:
    ...
    def generate_dualc_input(self):
        for dataset_type in self.dataset_types:
            ...
            # region_features = []
            image_labels = []
            # with open('../datasets/twitter2017/'+dataset_type+'_cap.json', 'r') as f:
            #     json_data = f.read()
            #     image_cap = json.loads(json_data)
            with open('../../lqmasa/data/ANPS/output.json', 'r') as f:
                json_data = f.read()
            ...
            for image_path in image_l:
                ...
                #cap_sentence=image_cap.get(image_path)
                #cap_sentence=cap_sentence.split(' ')
                #cap_sentences.append(cap_sentence)
            ...
            #tokenized_inputs['cap_input_ids']=tokenized_inputs_cap['input_ids']
            #tokenized_inputs['cap_attention_mask']=tokenized_inputs_cap['attention_mask']
            if dataset_type == 'train':
                tokenized_inputs['image_labels']=image_labels
    ...
    def create_dependency_matric(self, image_id):
        ...
        dependency_matrix_path = os.path.join('../../TextSpaCy/multi_matrices_dtca', image_pt)
...
def main():
    ...
    if text_model_type == 'bert':
        ...
        text_model = '../../lqmasa/roberta-base-cased'
