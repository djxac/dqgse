...
parser.add_argument('--output_result_file', type=str,default="./result_15.txt",nargs='?', help='display a string')
...
parser.add_argument('--random_seed', type=int, default=1920,nargs='?')
